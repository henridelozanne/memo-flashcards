...
export function scheduleAfterReview(card: CardLike, result: ReviewResult, nowMs = Date.now()): CardLike {
...
export function selectDueCards(cards: CardLike[], nowMs: number, options?: { excludeC6?: boolean }): CardLike[] {
...
export function sortDueCardsDeterministically(cards: CardLike[], collectionsOrder: CollectionOrder[]): CardLike[] {
