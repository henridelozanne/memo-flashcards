...
import FeatureRequestPage from '@/pages/feature-request.vue'
  ...
  messages: {
    fr: {
      ...
      contact: {
        ...
        message: 'Message',
        featureRequestPlaceholder: 'Décrivez la fonctionnalité souhaitée...',
        send: 'Envoyer',
        success: 'Merci !',
...
describe('Feature Request Page', () => {
  ...
  it('renders correctly', () => {
    const wrapper = mount(FeatureRequestPage, {
      global: {
        plugins: [i18n],
        stubs: {
          PageHeader: true,
  ...
  it('displays form title', () => {
    ...
    expect(wrapper.text()).toContain('Demander une fonctionnalité')
  })
  ...
  it('shows success message after successful submission', async () => {
    ...
    await wrapper.find('#message').setValue('Great feature request!')
