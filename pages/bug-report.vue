<template>
  <div class="flex h-full flex-col p-6">
    <PageHeader :title="$t('settings.bugReport')" :back-button-visible="true" @back="$router.back()" />
      ...
      <form v-if="!submitted" class="flex flex-col gap-4" @submit.prevent="handleSubmit">
        ...
        <div>
          ...
          <textarea
            ...
            :placeholder="$t('contact.bugReportPlaceholder')"
          />
...
defineOptions({ name: 'BugReportPage' })
  ...
  try {
    const response = await fetch('https://api.web3forms.com/submit', {
      ...
      body: JSON.stringify({
        ...
        subject: 'Nouveau signalement de bug - Remember',
